                    ...
                    {programs.map((program) => (
                        ...
                        >
                            ...
                            <div className="p-6 relative">
                                {/* Floating Icon */}
                                <div className="absolute -top-6 left-6 bg-white p-3 rounded-lg shadow-md border border-gray-50 group-hover:bg-[#e5eff8] group-hover:text-white transition-colors duration-300">
                                ...
                                <Link to={program.path} className="group inline-block">
